...
struct sc_screen {
    ...
    bool reconnecting;
    bool restore_mouse_capture;
    bool reopening; // fixed before starting each decoder
    char *connected_title;
    bool disconnected;
...
// Keep the last frame visible and suspend device input.
void
...
// Discard frames after all producers have joined.
void
